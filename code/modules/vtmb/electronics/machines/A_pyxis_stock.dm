...
GLOBAL_LIST_INIT(CLINIC_category_access, list(
	"Medical Supplies" = CLINIC_ACCESS_BASIC,
	"Cleaning Supplies" = CLINIC_ACCESS_BASIC,
	"Office Supplies" = CLINIC_ACCESS_BASIC,

	"Medications" = CLINIC_ACCESS_MEDICAL,
	"Staff Equipment" = CLINIC_ACCESS_MEDICAL,

	"Controlled Substances" = CLINIC_ACCESS_FULL

))

// Initialize stock - all of it will be alphabtized by the .jsx
/proc/init_CLINIC_stock()
	var/list/stock = list()

	// Medical Supplies
	stock["Medical Supplies"] = list(
	...
	stock["Controlled Substances"] = list(
